...
def kb_image():
    ImageK1 = Image.open('./pages/kb1.jpg')
...
def kb2_image():
    KBImage2 = Image.open('./pages/Ducky_One_3_SF.jpg')
...
def kb3_image():
    image3 = Image.open('./pages/Ducky_One_3_Fuji_Hotswap.jpg')
...
def kb4_image():
    Image4 = Image.open('./pages/MK_Duo.jpg')
...
def kb5_image():
    image5 = Image.open('./pages/Varmilo_x_MK_Glintstone.jpg')

...
def display_cheap_case():
    ...
    cheap_case = Image.open('./pages/cheap_computer_case.jpg')
...
def display_mid_case():
    ...
    mid_case = Image.open('./pages/computercase1.jpg')
...
def display_expensive_case():
    ...
    expensive_case = Image.open('./pages/computercase2.jpg')
...
def display_case():
    ...
    case = Image.open('./pages/computercase3.jpg')
...
def display_case2():
    ...
    case2 = Image.open('./pages/computercase4.jpg')

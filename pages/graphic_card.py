...
def gcard1_image():
    image1 = Image.open('./graphiccard1.jpg')
...
def gcard2_image():
    Image2 = Image.open('./graphiccard2.jpg')
...
def gcard3_image():
    image3 = Image.open('./graphiccard3.jpg')
...
def gcard4_image():
    Image4 = Image.open('./graphiccard4.jpg')
...
def gcard5_image():
    image5 = Image.open('./graphiccard5.jpg')
